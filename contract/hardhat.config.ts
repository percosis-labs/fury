...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    fury17000: {
      url: "https://evm.app.internal.testnet-17000.us-east.production.fury.io:443",
      accounts: [
        // testnet user key
      ],
    },
    demonet: {
      url: "https://evm.data.demonet.us-east.production.fury.io:443",
      accounts: [
    ...
    internal_testnet: {
      url: "https://evm.app.internal.testnet.us-east.production.fury.io:443",
      accounts: [
        "247069F0BC3A5914CB2FD41E4133BBDAA6DBED9F47A01B9F110B5602C6E4CDD9",
      ],
    },
    fury: {
      ...
      accounts: [
        // fury keys unsafe-export-eth-key user --keyring-backend test
