...
fury config node "http://localhost:8545"
...
# setup dev wallet
echo "net pulp faint autumn have fame tribe bacon nose broom hire pluck credit toy trick inform improve violin pencil swallow bronze smile camp turkey " | fury keys add --recover dev-test-wallet

DEV_TEST_WALLET_ADDRESS="0x2CFBFAD98E2B95EDB8D9D936F3107456E9621052"
