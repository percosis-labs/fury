...
func getCmdConvertEvmERC20FromCoin() *cobra.Command {
	return &cobra.Command{
		...
		Example: fmt.Sprintf(
			`%s tx %s convert-evm-erc20-from-coin 0x7Bbf300890857b8c241b219C6a489431669b3aFA 500000000erc20/weth --from <key> --gas 2000000`,
...
func getCmdConvertEvmERC20ToCoin() *cobra.Command {
	return &cobra.Command{
		...
		Example: fmt.Sprintf(`
%[1]s tx %[2]s convert-evm-erc20-to-coin fury10wlnqzyss4accfqmyxwx5jy5x9nfkwh6qm7n4t 0x595F0CE3e840FDcC0676CF522477B6b46a6bC734 1000000000000000 --from <key> --gas 1000000
`, version.AppName, types.ModuleName,
		),
...
func getCmdMsgConvertCosmosCoinFromERC20() *cobra.Command {
	return &cobra.Command{
		...
		Example: fmt.Sprintf(
			`Convert ERC20 representation of 500 ATOM back to a Cosmos coin, sending to fury1q0dkky0505r555etn6u2nz4h4kjcg5y8dg863a:
  %s tx %s convert-cosmos-coin-from-erc20 fury1q0dkky0505r555etn6u2nz4h4kjcg5y8dg863a 500000000ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2 --from <key> --gas 2000000`,
			version.AppName, types.ModuleName,
		),
		Args: cobra.ExactArgs(2),
		RunE: func(cmd *cobra.Command, args []string) error {
