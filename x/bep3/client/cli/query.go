...
Example:
$ fucli q bep3 swaps --involve=fury1l0xsq2z7gqd7yly0g40y5836g0appumark77ny
$ fucli q bep3 swaps --expiration=280
$ fucli q bep3 swaps --status=(Open|Completed|Expired)
$ fucli q bep3 swaps --direction=(Incoming|Outgoing)
$ fucli q bep3 swaps --page=2 --limit=100
`,
		),
		RunE: func(cmd *cobra.Command, args []string) error {
