...
Example:
$ fucli q cdp cdps --collateral-type=bnb
$ fucli q cdp cdps --owner=fury1hatdq32u5x4wnxrtv5wzjzmq49sxgjgsj0mffm
$ fucli q cdp cdps --id=21
$ fucli q cdp cdps --ratio=2.75
$ fucli q cdp cdps --page=2 --limit=100
`,
		),
		RunE: func(cmd *cobra.Command, args []string) error {
