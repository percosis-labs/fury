...
var (
	_ sdk.Msg = &MsgClaimUSDFMintingReward{}
	...
	_ legacytx.LegacyMsg = &MsgClaimUSDFMintingReward{}
...
const (
	TypeMsgClaimUSDFMintingReward = "claim_usdf_minting_reward"
...
func NewMsgClaimUSDFMintingReward(sender string, multiplierName string) MsgClaimUSDFMintingReward {
	return MsgClaimUSDFMintingReward{
		Sender:         sender,
...
func (msg MsgClaimUSDFMintingReward) Route() string { return RouterKey }

// Type returns a human-readable string for the message, intended for utilization within tags.
func (msg MsgClaimUSDFMintingReward) Type() string { return TypeMsgClaimUSDFMintingReward }
