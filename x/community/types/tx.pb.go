...
// source: fury/community/v1beta1/tx.proto
...
func (*MsgFundCommunityPool) Descriptor() ([]byte, []int) {
	return fileDescriptor_e1cb75125456894c, []int{0}
}
...
func (*MsgFundCommunityPoolResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e1cb75125456894c, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgFundCommunityPool)(nil), "fury.community.v1beta1.MsgFundCommunityPool")
	proto.RegisterType((*MsgFundCommunityPoolResponse)(nil), "fury.community.v1beta1.MsgFundCommunityPoolResponse")
}

func init() { proto.RegisterFile("fury/community/v1beta1/tx.proto", fileDescriptor_e1cb75125456894c) }

var fileDescriptor_e1cb75125456894c = []byte{
	...
	0x52, 0x54, 0xc3, 0xec, 0x77, 0xf2, 0x5d, 0xf1, 0x48, 0x8e, 0xf1, 0xc4, 0x23, 0x39, 0xc6, 0x0b,
	0x8f, 0xe4, 0x18, 0x1f, 0x3c, 0x92, 0x63, 0x9c, 0xf0, 0x58, 0x8e, 0xe1, 0xc2, 0x63, 0x39, 0x86,
	0x1b, 0x8f, 0xe5, 0x18, 0xa2, 0xf4, 0x91, 0x42, 0xab, 0x20, 0xb5, 0x28, 0x39, 0xbf, 0x38, 0xb3,
	0x58, 0x37, 0x27, 0x31, 0xa9, 0x58, 0x1f, 0x9c, 0x38, 0x2a, 0x90, 0x92, 0x07, 0x38, 0xe8, 0x92,
	0xd8, 0xc0, 0x31, 0x66, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xb4, 0xb5, 0x8c, 0x7c, 0x3d, 0x02,
	0x00, 0x00,
}
...
func (c *msgClient) FundCommunityPool(ctx context.Context, in *MsgFundCommunityPool, opts ...grpc.CallOption) (*MsgFundCommunityPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.community.v1beta1.Msg/FundCommunityPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_FundCommunityPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.community.v1beta1.Msg/FundCommunityPool",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fury.community.v1beta1.Msg",
	...
	Metadata: "fury/community/v1beta1/tx.proto",
}
